...
export const PACKS = [
  {
    id: "pack_hwatu",
    name: "화투 묶음",
    description: "일반 카드 후보 3장 중 1장을 골라 덱에 추가.",
    category: "card",
    price: 4,
    choices: 3,
    picks: 1,
  ...
  },
  {
    id: "pack_painter",
    name: "화공 묶음",
    description: "화공패 후보 3장 중 1장을 골라 즉시 사용.",
    category: "painter",
    price: 5,
    choices: 3,
    picks: 1,
    assetTag: "pack:painter",
  },
  {
    id: "pack_book",
    name: "비결 묶음",
    description: "비결서 후보 3장 중 1장을 골라 즉시 사용.",
    category: "book",
    price: 5,
    choices: 3,
    picks: 1,
  ...
  },
  {
    id: "pack_talisman",
    name: "부적 묶음",
    description: "부적 후보 3개 중 1개를 골라 보유.",
    category: "talisman",
    price: 6,
    choices: 3,
    picks: 1,
    assetTag: "pack:talisman",
  },
  {
    id: "pack_forbidden",
    name: "금단 묶음",
    description: "금단패 후보 3장 중 1장을 골라 대가를 확인하고 즉시 사용.",
    category: "forbidden",
    price: 8,
    choices: 3,
    picks: 1,
    assetTag: "pack:forbidden",
  },
