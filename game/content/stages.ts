...
export const STAGES: StageDefinition[] = [
  ...
  { stage: 9, month: 9, name: "가을 두목 · 역달력", subtitle: "짓을 짜기가 까다로워진다", target: 11_200, bossId: "boss_reverse_calendar", weatherId: "clear", assetTag: "stage_09_chrysanthemum_boss" },
  ...
  { stage: 11, month: 11, name: "오동의 먹구름", subtitle: "짓이 막혀도 엔진은 돈다", target: 30_500, bossId: null, weatherId: "snow", assetTag: "stage_11_paulownia" },
