...
| 타입 · 테스트 | TypeScript 5.9 · Vitest 4 | 규칙 엔진이 순수 함수라 36개 파일의 250개 테스트로 빠르게 검증 |
...
규칙이 자주 바뀌는 게임이라 회귀 방지에 비중을 뒀습니다. 현재 36개 테스트 파일에서 250개 사례를 실행합니다.
...
- 결정론적 순수 함수여야 250개의 테스트로 주요 규칙을 잠글 수 있기 때문에
