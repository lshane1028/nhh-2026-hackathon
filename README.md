...
현재 브랜치는 한 판짜리 고스톱 데모가 아니라, 봄부터 겨울까지 계절마다 두 판씩 이어지는 8스테이지 로그라이트 수직 슬라이스입니다.
...
- 40종 전술이 들어가는 별도의 전술 덱과 매 대국 3장 무작위 드로우
- 전술 추가·유물·회복 중 하나를 고르는 3택 보상
- 27종 유물의 영구 효과와 광·띠·열끗·피·포획·판술·견제·고 빌드
- 계절마다 얻는 정리 기회로 덱에서 원하는 전술 사본 제거
- 중복 전술은 별도 카드로 드로우되고 사용되어 핵심 카드의 출현 확률을 직접 조절
- 보유 전술·유물 태그에 따라 같은 빌드 보상의 등장 확률 상승
