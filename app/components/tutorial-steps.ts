...
export const TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  },
  {
    id: "shake",
    target: "submit",
    title: "같은 월 세 장은 두 갈래",
    body: "같은 월 카드 세 장을 골라 제출하면 흔들기와 폭탄 중 하나를 고르게 됩니다. 흔들기는 이번 판 판돈이 20% 늘고, 폭탄은 이번 손의 월 합에 +24가 붙습니다. 목표가 빠듯하면 폭탄, 넉넉히 넘길 자신이 있으면 흔들기입니다.",
  },
  {
    id: "collection",
    target: "collection",
  ...
  },
  {
    ...
    target: "dept-book",
    title: "비결서점",
    body: "적힌 족보의 기본 배수를 영구히 한 단계 올립니다. 자주 만드는 족보부터 키우면 매 손이 조금씩 세집니다.",
    when: (state) => state.screen === "shop",
  },
  {
    id: "dept-workshop",
